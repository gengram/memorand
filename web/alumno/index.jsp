                        ...
                        <div class="card mb-5 shadow" style="max-width: 1070px; max-height: 170px; background-color: #FFF89A; border: none">
                            <div class="row g-0">
                                ...
                                <div class="col-9">
                                    ...
                                    <button type="button" class="btn custom-b4 btn-lg mx-3 float-start mt-4 ms-5 mb-5 custom-size-b1 shadow-lg" style="height: 110px; width: 210px"><a class="l" href="/memorand/alumno/chat.jsp"><i class="bi bi-telegram custom-icon5 mt-0"></i><br><b>CHAT</b></a></button>
                                </div>
                            </div>
                        </div>
                    </div> 
