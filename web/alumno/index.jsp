    ...
    <body>
        ...
        <div class="container text-center" >
            <div class="row" >
                ...
                <div class="col-10">
                    <div class="row" ">
                        <h1 class="text-start mt-5 text-yellow-osc" style="font-size: 350%;">Tu zona</h1>
                        <h1 class="text-start mt-5 text-yellow-osc" style="font-size: 200%;">Bienvenido <%=nom_usuario%> <%=pat_usuario%></h1><br>
