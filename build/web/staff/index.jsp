                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button type="button" class="btn custom-b4 btn-lg mt-4 float-start custom-size-b1 shadow" ><a class="l" href="../listaadmin?a=v"><i class="bi bi-person-fill-gear custom-icon3"></i><br><b>VER ADMINISTRADORES</b></a></button>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button type="button" class="btn custom-b4 btn-lg mt-4 float-start custom-size-b1 shadow" ><a class="l" href="../listainst?a=v"><svg class="mb-2" width="55" height="55" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M23.3 7.5C22.5 7 12.8.2 12.8.2c-.4-.3-1.2-.3-1.6 0C11.2.2 1.4 7 .7 7.5s-.7 1-.7 1V9c0 .5.4 1 .9 1H2v12H1c-.6 0-1 .5-1 1v1h24v-1c0-.6-.5-1-1-1h-1V10h1c.5 0 1-.4 1-1v-.5s.1-.4-.7-1zM12 2l8.9 6H3.1L12 2zM3 22V10h2v12H3zm3 0V10h4v12H6zm5 0V10h2v12h-2zm3 0V10h4v12h-4zm7 0h-2V10h2v12z" fill="#00a98f" class="fill-000000"></path></svg><br><b>VER INSTITUCIONES</b></a></button>
                                    </div>
                                    <div class="col-6">
