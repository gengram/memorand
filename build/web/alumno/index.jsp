                        ...
                        <div class="card mb-3" style="max-width: 990px; max-height: 165px;background-color: #A3E3CA; border: none">
                            <div class="row g-0">
                                ...
                                <div class="col-9">
                                    ...
                                    <button type="button" class="btn custom-b3 btn-lg mx-3 float-end mt-4 ms-2 mb-5 custom-size-b1" style="height: 110px; width: 210px"><a class="l" href="/memorand/alumno/chat.jsp"><i class="bi bi-telegram custom-icon1"></i><br>CHAT</a></button>
