                    ...
                    <div class="row" ">
                        ...
                        <div class="card mb-5 shadow" style="max-width: 1070px; max-height: 170px; background-color: #FFF89A; border: none">
                            <div class="row g-0">
                                ...
                                <div class="col-9">
                                    <button  type="button" class="btn custom-b4 btn-lg float-end me-5 mt-4 custom-size-b1 shadow-lg" style="height: 110px; width: 210px"><a class="l" href="/memorand/alumno/clases.jsp"><svg width="60" height="60"  viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M445.055 384.794v-162.93l-26.25 13.125v149.788l-17.504 45.008h61.25l-17.496-44.991zM229.065 306.37 121.3 252.49v53.776c0 36.243 58.764 65.625 131.25 65.625 72.49 0 131.25-29.382 131.25-65.625V252.49l-107.772 53.884c-18.447 7.307-28.515 7.305-46.963-.003Z" fill="#404040" class="fill-000000"></path><path d="m264.291 282.897 186.52-93.26c6.459-3.229 6.459-8.51 0-11.74l-186.52-93.26c-6.455-3.229-17.021-3.229-23.48 0l-186.52 93.26c-6.455 3.229-6.455 8.51 0 11.74l186.52 93.26c6.459 3.229 17.025 3.229 23.48 0Z" fill="#404040" class="fill-000000"></path></svg><br><b>CLASES</b</a></button>
                                    <button type="button" class="btn custom-b4 btn-lg float-start mt-4 custom-size-b1 shadow-lg" style="height: 110px; width: 210px"><b class="text-gray-clr"><a class="l" href="/memorand/alumno/foro.jsp"><svg  width="60" height="60"  viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h48v48H0z" fill="none"></path><path d="M42 12h-4v18H12v4c0 1.1.9 2 2 2h22l8 8V14c0-1.1-.9-2-2-2zm-8 12V6c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2v28l8-8h20c1.1 0 2-.9 2-2z" fill="#404040" class="fill-000000"></path></svg><br>FORO</a></b></button>
                                    <button type="button" class="btn custom-b4 btn-lg mx-3 float-start mt-4 ms-5 mb-5 custom-size-b1 shadow-lg" style="height: 110px; width: 210px"><a class="l" href="/memorand/alumno/chats.jsp"><i class="bi bi-telegram custom-icon5 mt-0"></i><br><b>CHAT</b></a></button>
                                </div>
                            </div>
                        </div>
                    </div> 
